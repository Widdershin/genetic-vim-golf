...
function golfDriver(sink$, streamAdapter) {
  ...
  var _streamAdapter$makeSu = streamAdapter.makeSubject(),
      observer = _streamAdapter$makeSu.observer,
      stream = _streamAdapter$makeSu.stream;
...
function view(golf) {
  return (0, _dom.div)([(0, _dom.div)(['Start text:', (0, _dom.textarea)('.start-text')]), (0, _dom.div)(['Target text:', (0, _dom.textarea)('.target-text')]), (0, _dom.div)(['Solution:', (0, _dom.pre)(golf.solution), 'Result', (0, _dom.pre)(golf.result), 'Generation ' + golf.generation])]);
}
...
function main(_ref) {
  ...
  var startText$ = DOM.select('.start-text').events('change').map(function (ev) {
    return ev.target.value;
  }).startWith('');

  var targetText$ = DOM.select('.target-text').events('change').map(function (ev) {
    return ev.target.value;
  });

  var golfInput$ = _xstream2.default.combine(startText$, targetText$);

  var solution$ = Golf.startWith({ result: '', generation: 0, solution: '' });
...
},{"./index":2,"./worker":140,"@cycle/dom":15,"@cycle/xstream-run":25,"webworkify":134,"xstream":136}],2:[function(require,module,exports){
'use strict';
...
var _randomString = require('./src/random-string');

var _randomString2 = _interopRequireDefault(_randomString);

var _virtualVim = require('./src/virtual-vim');

var _virtualVim2 = _interopRequireDefault(_virtualVim);

var _stringSplice3 = require('./src/string-splice');

var _stringSplice4 = _interopRequireDefault(_stringSplice3);
...
function generateCommand() {
  return _virtualVim2.default.generateCommand();
}

function generateSolution() {
  var numberOfCommands = _lodash2.default.random(1, 5);

  return _lodash2.default.range(numberOfCommands).map(generateCommand);
}

function rankGeneration(generation) {
  //        Rank = (total - score) / total
  //        Rank of the worst individual should be 1
  var totalScore = _lodash2.default.sumBy(generation, 'score');

  generation.reduce(function (accumulatedScore, solution) {
...
function breedChildren(generation, childrenToBreed) {
  ...
  var rankedGeneration = rankGeneration(generation);
  ...
  function breed() {
    ...
    var firstParentRoll = _lodash2.default.random(0, 1, true);

    var firstParent = rankedGeneration.find(function (solution) {
      return solution.rank > firstParentRoll;
    });

    var secondParentRoll = _lodash2.default.random(0, 1, true);

    var secondParent = rankedGeneration.find(function (solution) {
      return solution.rank > secondParentRoll && solution !== firstParent;
    });

    if (!secondParent) {
      secondParent = rankedGeneration.find(function (solution) {
        return solution !== firstParent;
      });
    }

    var firstParentCrossoverIndex = _lodash2.default.random(0, firstParent.length - 1);
    var secondParentCrossoverIndex = _lodash2.default.random(0, secondParent.length - 1);

    var firstParentCommand = firstParent[firstParentCrossoverIndex];
    var secondParentCommand = secondParent[secondParentCrossoverIndex];

    return [firstParent.map(function (command, index) {
      return index === firstParentCrossoverIndex ? secondParentCommand : command;
    }), secondParent.map(function (command, index) {
      return index === secondParentCrossoverIndex ? firstParentCommand : command;
    })];
  }

  return _lodash2.default.flatten(_lodash2.default.range(childrenToBreed / 2).map(breed));
}

function mutateString(string) {
  var indexToMutate = _lodash2.default.random(string.length - 1);

  var newChar = (0, _randomString2.default)(1);

  var _stringSplice = (0, _stringSplice4.default)(string, indexToMutate, 1, newChar),
      _stringSplice2 = _slicedToArray(_stringSplice, 1),
      newString = _stringSplice2[0];
...
function mutateCommand(command) {
  if (command.type === 'i') {
    var mutatedString = mutateString(command.stringToInsert);
  ...
  if (command.type === 'a') {
    var _mutatedString = mutateString(command.stringToAppend);

    return Object.assign({}, command, {
      stringToAppend: _mutatedString,
      string: 'a' + _mutatedString + '<Esc>'
    });
  }

  if (command.type === 'A') {
    var _mutatedString2 = mutateString(command.stringToAppend);

    return Object.assign({}, command, {
      stringToAppend: _mutatedString2,
      string: 'A' + _mutatedString2 + '<Esc>'
    });
  }
...
function mutate(solution) {
  ...
  var approach = _lodash2.default.sample(['mutateNode', 'removeNode']);

  if (approach === 'mutateNode') {
    var nodeIndexToMutate = _lodash2.default.random(solution.length - 1);

    return solution.map(function (command, index) {
    ...
    var clonedSolution = solution.slice();

    var _nodeIndexToMutate = _lodash2.default.random(solution.length - 1);

    clonedSolution.splice(_nodeIndexToMutate, 1);
...
function evolve(fitnessFunction, populationSize) {
  return function (generation) {
    ...
    generation.forEach(function (solution) {
      solution.score = fitnessFunction(solution);
    });

    var sortedGeneration = _lodash2.default.sortBy(generation, 'score');
    var topSolutions = sortedGeneration.slice(0, populationSize / 4);

    var children = breedChildren(sortedGeneration, populationSize / 2).map(mutate);
    var newSolutions = _lodash2.default.range(populationSize / 4).map(generateSolution);

    return topSolutions.concat(children, newSolutions);
  };
}

function golf(input, output) {
  var populationSize = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 128;

  function fitness(solution) {
    var solutionOutput = (0, _virtualVim2.default)({ solution: solution, input: input });

    return solution.length + _fastLevenshtein2.default.get(solutionOutput, output) * 100;
  }

  var population = _lodash2.default.range(populationSize).map(generateSolution);
  ...
  var producer = {
    start: function start(listener) {
      function go() {
        var newPopulation = evolve(fitness, populationSize)(_population);

        _population = newPopulation;

        var bestSolution = _lodash2.default.minBy(_population, fitness);
        var bestSolutionString = bestSolution.map(function (command) {
          return command.string;
        }).join('');

        var result = (0, _virtualVim2.default)({ solution: bestSolution, input: input });

        listener.next({ solution: bestSolutionString, result: result, generation: generation });
...
},{"./src/random-string":137,"./src/string-splice":138,"./src/virtual-vim":139,"fast-levenshtein":89,"lodash":109,"xstream":136}],3:[function(require,module,exports){
"use strict";
...
},{"./fromEvent":12,"@cycle/xstream-adapter":24,"xstream":136}],5:[function(require,module,exports){
"use strict";
var xstream_1 = require('xstream');
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var fromEvent_1 = require('./fromEvent');
...
},{"./fromEvent":12,"@cycle/xstream-adapter":24,"xstream":136}],6:[function(require,module,exports){
"use strict";
...
},{"./ScopeChecker":10,"./utils":23,"matches-selector":110}],7:[function(require,module,exports){
"use strict";
var ScopeChecker_1 = require('./ScopeChecker');
var utils_1 = require('./utils');
var matchesSelector;
...
},{"./ScopeChecker":10,"./utils":23,"matches-selector":110}],8:[function(require,module,exports){
"use strict";
var xstream_1 = require('xstream');
var xstream_adapter_1 = require('@cycle/xstream-adapter');
...
},{"@cycle/xstream-adapter":24,"xstream":136}],9:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
...
},{"./BodyDOMSource":4,"./DocumentDOMSource":5,"./ElementFinder":6,"./EventDelegator":7,"./fromEvent":12,"./isolate":16,"./utils":23,"@cycle/xstream-adapter":24,"matches-selector":110,"xstream":136}],10:[function(require,module,exports){
"use strict";
...
},{"./hyperscript":14,"snabbdom-selector/lib/classNameFromVNode":112,"snabbdom-selector/lib/selectorParser":113}],12:[function(require,module,exports){
"use strict";
var xstream_1 = require('xstream');
...
},{"xstream":136}],13:[function(require,module,exports){
"use strict";
var hyperscript_1 = require('./hyperscript');
...
},{"./hyperscript":14}],14:[function(require,module,exports){
"use strict";
...
},{"snabbdom/is":123,"snabbdom/vnode":132}],15:[function(require,module,exports){
"use strict";
...
},{"./hyperscript":14,"./hyperscript-helpers":13,"./makeDOMDriver":18,"./makeHTMLDriver":19,"./mockDOMSource":20,"snabbdom/thunk":131}],16:[function(require,module,exports){
"use strict";
var utils_1 = require('./utils');
...
},{"es6-map":77}],18:[function(require,module,exports){
"use strict";
...
},{"./MainDOMSource":9,"./VNodeWrapper":11,"./isolateModule":17,"./modules":21,"./transposition":22,"./utils":23,"@cycle/xstream-adapter":24,"es6-map":77,"snabbdom":130,"xstream":136}],19:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var transposition_1 = require('./transposition');
...
},{"./HTMLSource":8,"./transposition":22,"@cycle/xstream-adapter":24,"snabbdom-to-html":115}],20:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var xstream_1 = require('xstream');
...
},{"@cycle/xstream-adapter":24,"xstream":136}],21:[function(require,module,exports){
"use strict";
...
},{"snabbdom/modules/attributes":124,"snabbdom/modules/class":125,"snabbdom/modules/eventlisteners":126,"snabbdom/modules/hero":127,"snabbdom/modules/props":128,"snabbdom/modules/style":129}],22:[function(require,module,exports){
"use strict";
var xstream_adapter_1 = require('@cycle/xstream-adapter');
var xstream_1 = require('xstream');
...
},{"@cycle/xstream-adapter":24,"xstream":136}],23:[function(require,module,exports){
"use strict";
...
},{"xstream":136}],25:[function(require,module,exports){
"use strict";
...
},{"@cycle/base":3,"@cycle/xstream-adapter":24}],26:[function(require,module,exports){
/*!
...
},{"es5-ext/object/copy":49,"es5-ext/object/map":58,"es5-ext/object/normalize-options":59,"es5-ext/object/valid-callable":64,"es5-ext/object/valid-value":65}],28:[function(require,module,exports){
'use strict';
...
},{"es5-ext/object/assign":46,"es5-ext/object/is-callable":52,"es5-ext/object/normalize-options":59,"es5-ext/string/#/contains":66}],29:[function(require,module,exports){
...
},{"../../function/is-arguments":34,"../../function/is-function":35,"../../number/to-pos-integer":44,"../../object/is-value":54,"../../object/valid-callable":64,"../../object/valid-value":65,"../../string/is-string":69,"es6-symbol":83}],34:[function(require,module,exports){
"use strict";
...
},{"./":73,"d":28,"es5-ext/object/set-prototype-of":61,"es5-ext/string/#/contains":66,"es6-symbol":83}],71:[function(require,module,exports){
"use strict";
...
},{"./array":70,"./string":75,"./valid-iterable":76,"es5-ext/function/is-arguments":34,"es5-ext/string/is-string":69,"es6-symbol":83}],73:[function(require,module,exports){
"use strict";
...
},{"d":28,"d/auto-bind":27,"es5-ext/array/#/clear":29,"es5-ext/object/assign":46,"es5-ext/object/valid-callable":64,"es5-ext/object/valid-value":65,"es6-symbol":83}],74:[function(require,module,exports){
"use strict";
...
},{"es5-ext/function/is-arguments":34,"es5-ext/object/is-value":54,"es5-ext/string/is-string":69,"es6-symbol":83}],75:[function(require,module,exports){
...
},{"./":73,"d":28,"es5-ext/object/set-prototype-of":61,"es6-symbol":83}],76:[function(require,module,exports){
"use strict";
...
},{"./iterator-kinds":80,"d":28,"es5-ext/object/set-prototype-of":61,"es6-iterator":73,"es6-symbol":83}],82:[function(require,module,exports){
'use strict';
...
},{"./is-native-implemented":79,"./lib/iterator":81,"d":28,"es5-ext/array/#/clear":29,"es5-ext/array/#/e-index-of":30,"es5-ext/object/set-prototype-of":61,"es5-ext/object/valid-callable":64,"es5-ext/object/valid-value":65,"es6-iterator/for-of":71,"es6-iterator/valid-iterable":76,"es6-symbol":83,"event-emitter":88}],83:[function(require,module,exports){
'use strict';
...
},{"./validate-symbol":87,"d":28}],87:[function(require,module,exports){
'use strict';
...
},{"d":28,"es5-ext/object/valid-callable":64}],89:[function(require,module,exports){
...
},{"timers":133}],90:[function(require,module,exports){
/**
...
},{"lodash.isarguments":102,"lodash.isarray":103}],91:[function(require,module,exports){
/**
...
},{"lodash._baseindexof":92,"lodash._cacheindexof":95,"lodash._createcache":96}],94:[function(require,module,exports){
/**
...
},{"lodash._getnative":97}],97:[function(require,module,exports){
/**
...
},{"lodash._root":98}],100:[function(require,module,exports){
/**
 * lodash 3.2.0 (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
 * Copyright 2012-2016 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash._root":98}],101:[function(require,module,exports){
/**
 * lodash 3.0.2 (Custom Build) <https://lodash.com/>
 * Build: `lodash modern modularize exports="npm" -o ./`
 * Copyright 2012-2015 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash._basefor":91,"lodash._bindcallback":94,"lodash.keys":105}],102:[function(require,module,exports){
/**
...
},{"lodash.deburr":99,"lodash.words":108}],105:[function(require,module,exports){
/**
 * lodash 3.1.2 (Custom Build) <https://lodash.com/>
 * Build: `lodash modern modularize exports="npm" -o ./`
 * Copyright 2012-2015 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash._getnative":97,"lodash.isarguments":102,"lodash.isarray":103}],106:[function(require,module,exports){
/**
...
},{"lodash._baseflatten":90,"lodash._baseuniq":93,"lodash.restparam":106}],108:[function(require,module,exports){
/**
 * lodash 3.2.0 (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
 * Copyright 2012-2016 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash._root":98}],109:[function(require,module,exports){
(function (global){
/**
 * @license
...
},{"./selectorParser":113}],113:[function(require,module,exports){
'use strict';
...
},{"browser-split":26}],114:[function(require,module,exports){
...
},{"./init":116,"./modules/attributes":117,"./modules/style":118}],116:[function(require,module,exports){
...
},{"./container-elements":114,"./parse-selector":119,"./void-elements":120}],117:[function(require,module,exports){
...
},{"../parse-selector":119,"lodash.escape":100,"lodash.forown":101,"lodash.union":107}],118:[function(require,module,exports){
...
},{"lodash.escape":100,"lodash.forown":101,"lodash.kebabcase":104}],119:[function(require,module,exports){
...
},{"browser-split":26}],120:[function(require,module,exports){
...
},{"../is":123}],127:[function(require,module,exports){
...
},{"./htmldomapi":122,"./is":123,"./vnode":132}],131:[function(require,module,exports){
var h = require('./h');
...
},{"./h":121}],132:[function(require,module,exports){
...
},{"process/browser.js":111,"timers":133}],134:[function(require,module,exports){
...
},{"lodash":109}],138:[function(require,module,exports){
'use strict';
...
function stringSplice(str, index, count) {
  ...
  var splicedString = str.slice(0, index) + add + str.slice(index + count);
...
var _stringSplice9 = require('./string-splice');

var _stringSplice10 = _interopRequireDefault(_stringSplice9);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function makeRandomString() {
  return (0, _randomString2.default)(_lodash2.default.random(1, 10));
}
...
function r() {
  var replaceWith = (0, _randomString2.default)(1);
...
function i() {
  var stringToInsert = makeRandomString();
...
function a() {
  var stringToAppend = makeRandomString();
...
var commands = {
  x: function x(state) {
    ...
    var _stringSplice = (0, _stringSplice10.default)(line, state.cursor.column, 1),
        _stringSplice2 = _slicedToArray(_stringSplice, 2),
        newText = _stringSplice2[0],
        removedChar = _stringSplice2[1];
  ...
  p: function p(state) {
    ...
    var _stringSplice3 = (0, _stringSplice10.default)(line, state.cursor.column + 1, 0, state.clipboard || ''),
        _stringSplice4 = _slicedToArray(_stringSplice3, 1),
        newText = _stringSplice4[0];

    state.text.splice(state.cursor.row, 1, newText);

    return state;
  },
  i: function i(state, command) {
    var line = currentLine(state);

    var _stringSplice5 = (0, _stringSplice10.default)(line, state.cursor.column, 0, command.stringToInsert),
        _stringSplice6 = _slicedToArray(_stringSplice5, 1),
        newText = _stringSplice6[0];
  ...
  r: function r(state, command) {
    var line = currentLine(state);

    var _stringSplice7 = (0, _stringSplice10.default)(line, state.cursor.column, 1, command.replaceWith),
        _stringSplice8 = _slicedToArray(_stringSplice7, 1),
        newText = _stringSplice8[0];
...
function generateCommand() {
  return _lodash2.default.sample([x, p, i(), l, j, r(), $, a(), A()]);
}
...
},{"./random-string":137,"./string-splice":138,"lodash":109}],140:[function(require,module,exports){
'use strict';
...
exports.default = function (self) {
  self.addEventListener('message', function (message) {
    ...
    var _message$data = _slicedToArray(message.data, 2),
        startText = _message$data[0],
        targetText = _message$data[1];

    console.log(startText, targetText);

    var golf$ = (0, _index2.default)(startText, targetText);
...
var stream = _xstream2.default.create();

},{"./index":2,"xstream":136}]},{},[1]);
